...
namespace SCide
{
    internal sealed partial class DocumentForm : DockContent
    {
        ...
        private void DocumentForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            var dr = MessageBox.Show(this, message, Program.Title, MessageBoxButtons.YesNoCancel, MessageBoxIcon.Exclamation);
            switch (dr) {
        ...
        public bool Save()
        {
            return String.IsNullOrEmpty(_filePath) ? SaveAs() : Save(_filePath);
        }
